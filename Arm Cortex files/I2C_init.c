 ...
 * aangeroepen worden.
 * De functie vereist geen parameters en heeft geen return.
 * 
 * Voor het maken van dit bestand heb ik naar een voorbeeld van g4lvanix gekeken
...
void I2Cinit(void) {
	...
	I2C_InitStruct.I2C_Ack = I2C_Ack_Enable;		// ACK is aan
